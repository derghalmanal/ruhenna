 ...
 *
 * Rôle : consulter les messages reçus, les marquer comme lus, archiver et supprimer.
 */
  ...
  return (
    <div className="space-y-6">
            ...
            <>
              <div className="border-b border-warm-dark/20 p-4 flex items-center justify-between flex-wrap gap-2">
                <div>
                  ...
                  <div className="text-sm text-text-light flex flex-col gap-0.5 mt-1">
                    <div className="flex items-center gap-1">
                      <LuUser className="h-3.5 w-3.5" /> {selectedMessage.senderName} • {selectedMessage.email}
                    </div>
                    {selectedMessage.phone && (
                      <div className="flex items-center gap-1 text-primary font-medium">
                        <LuPhone className="h-3.5 w-3.5" /> {selectedMessage.phone}
                      </div>
                    )}
      ...
      <ConfirmModal
        ...
        message={`"${messageToDelete?.subject}" sera définitivement supprimé. Cette action est irréversible.`}
        variant="danger"
