 ...
 *
 * Rôle : gérer les prestations (durée/prix/actif) et accéder aux pages de création/édition.
 */
    ...
    <div className="space-y-6">
      ...
      <ConfirmModal
        ...
        message={
          deleteError
            ? deleteError
            : `Attention, la suppression du service "${serviceToDelete?.name}" pourrait impacter les réservations en cours.`
        }
