 ...
 * Admin — Blog (liste).
 *
 * Rôle : lister les articles, publier/dépublier, naviguer vers création/édition, supprimer.
 */
  ...
  return (
    <div className="space-y-6">
      ...
      <ConfirmModal
        ...
        message={`"${postToDelete?.title}" sera définitivement supprimé. Cette action est irréversible.`}
        variant="danger"
