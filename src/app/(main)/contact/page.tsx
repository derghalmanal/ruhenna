            ...
            <div className="glass-card p-8">
              {submitted ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <button
                    type="submit"
                    className="flex w-full items-center justify-center gap-2 rounded-full bg-primary px-6 py-4 font-semibold text-text-inverse transition-all hover:bg-primary-light hover:shadow-lg"
                  >
                    Envoyer
...
export default function ContactPage() {
  return (
    <Suspense fallback={<main className="section-padding"><div className="container-narrow text-center text-text-light">Chargement...</div></main>}>
      <ContactForm />
    </Suspense>
  );
}
